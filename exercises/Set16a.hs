...
instance Arbitrary Arg where
  arbitrary = do numbers <- choose (0,10)
                 variables <- elements "abcxyz"
                 elements [Number numbers, Variable variables]

instance Arbitrary Expression where
  arbitrary = do arbarg1 <- arbitrary :: Gen Arg
                 arbarg2 <- arbitrary :: Gen Arg
                 arbarg3 <- arbitrary :: Gen Arg
                 arbarg4 <- arbitrary :: Gen Arg
                 elements [Plus arbarg1 arbarg2, Minus arbarg3 arbarg4]
